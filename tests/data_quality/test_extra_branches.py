...
from arxiv_int.data_quality.dbt_yaml import emit_yaml
...
from arxiv_int.data_quality.pandera_checks import check_batch_rule, merge_batch_results
from arxiv_int.data_quality.rules import UnsupportedQualityMappingError, compile_rule_catalog
from arxiv_int.data_quality.semantic import domain_rule_result
...
def test_domain_adapter_returns_a_typed_result() -> None:
    ...
    catalog = load_ontology_catalog(discover_project_root(P(__file__)) / "ontology")
