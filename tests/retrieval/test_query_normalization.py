...
def test_accepted_profile_expands_declared_and_mechanical_variants() -> None:
    accepted = ACCEPTED_V1_QUERY_PROFILE
    assert query_variants("\u0411\u041f\u041b\u0410", profile_id=accepted) == (
        "\u0411\u041f\u041b\u0410",
        "\u0431\u0435\u0441\u043f\u0438\u043b\u043e\u0442\u043d\u044b\u0439 \u043b\u0435\u0442\u0430\u0442\u0435\u043b\u044c\u043d\u044b\u0439 \u0430\u043f\u043f\u0430\u0440\u0430\u0442",
    )
    assert "\u043a\u043e\u043c\u043f\u0440\u0435\u0441\u0441\u043e\u0440" in query_variants(
        "rjvghtccjh", profile_id=accepted
    )
    assert "\u043f\u043e\u0434\u0448\u0438\u043f\u043d\u0438\u043a" in query_variants(
        "podshipnik", profile_id=accepted
    )
    assert "\u0441\u043a-5" in query_variants("C\u041a-5", profile_id=accepted)
