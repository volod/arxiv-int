...
from arxiv_int.observability.logging.redact import redact_mapping, redact_text, shard_token
...
def test_extra_secrets_from_env_collects_credential_values() -> None:
    from arxiv_int.observability.logging.redact import extra_secrets_from_env
