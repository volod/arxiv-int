...
from arxiv_int.inference.client.stream import collect_text
...
from arxiv_int.inference.client.types import CAPABILITY_CHAT, CAPABILITY_EMBEDDINGS, ModelIdentity
from arxiv_int.inference.policy import log_outcome
from arxiv_int.inference.policy.schema import (
    MAX_REPAIR_ATTEMPTS,
    is_refusal_payload,
    parse_json_object,
    repair_user_message,
