...
def schema_metadata() -> sa.MetaData:
    ...
    sa.Table(
        ...
        sa.Column("language", sa.Text(), nullable=True, comment=None),
        sa.Column("language_confidence", DOUBLE_PRECISION(), nullable=True, comment=None),
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["corpus.documents.document_id"],
            name="fk_normalized_documents_document_id",
        ),
        schema="corpus",
        postgresql_partition_by="HASH (normalized_document_id)",
    ...
    sa.Table(
        ...
        sa.Column("score", DOUBLE_PRECISION(), nullable=True, comment=None),
        ...
        sa.ForeignKeyConstraint(
            ["document_id"],
            ["corpus.documents.document_id"],
            name="fk_duplicate_groups_document_id",
        ),
        schema="corpus",
        postgresql_partition_by="HASH (duplicate_membership_id)",
