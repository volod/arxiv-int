...
from arxiv_int.evaluation.evaluate.errors import EvaluationError
...
def _fixtures(args: argparse.Namespace, root: object) -> int:
    ...
    from arxiv_int.evaluation.evaluate.paths import proof_config_path, threshold_config_path
    from arxiv_int.evaluation.proof.model import capability_registry_document
    from arxiv_int.evaluation.proof.ops import threshold_document
