...
from arxiv_int.evaluation.eval_errors import FixtureCatalogError
from arxiv_int.evaluation.eval_paths import fixture_root
from arxiv_int.evaluation.families_corpus import (
    classification_family,
    extraction_family,
    reporting_family,
)
from arxiv_int.evaluation.families_domain import (
    anomaly_family,
    domain_artifact_family,
    domain_negative_family,
)
from arxiv_int.evaluation.families_knowledge import (
    catalog_family,
    entity_family,
    fact_family,
)
from arxiv_int.evaluation.families_ontology import (
    geotemporal_family,
    graph_family,
    ontology_family,
)
from arxiv_int.evaluation.families_search import russian_retrieval_family, semantic_family
from arxiv_int.evaluation.fixture_guard import collect_items, item_ledger
from arxiv_int.evaluation.fixture_kinds import ITEM_KINDS, SCHEMA_VERSION
from arxiv_int.evaluation.fixture_model import EvaluationItem, GoldFamily, family_from_payload
