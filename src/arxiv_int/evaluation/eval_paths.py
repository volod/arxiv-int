...
PROOF_CONFIG_RELATIVE = Path("configs") / "proofs" / "capabilities.json"
THRESHOLD_CONFIG_RELATIVE = Path("configs") / "evaluation" / "thresholds.json"
