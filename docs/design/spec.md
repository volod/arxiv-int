...
| 9 | `lexical-retrieval` | shipped | Synthetic Russian calibration and the provided-archive load/query integration test cover lexical integrity; judged archive-wide gold remains a production promotion gate | [Lexical retrieval](../impl/current/lexical-retrieval.md); [Historical run](../impl/records/0073-lexical-prove-lexical-retrieval-on-provided-archive.md) |
