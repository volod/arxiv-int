...
| 4 | `canonical-store` | planned | Extension compatibility and live schema upgrade/adoption are recorded; dbt ownership/build/test, backup, restore and projection checks remain | [Canonical store](../impl/current/canonical-store.md); [Open work](../impl/plan.md#canonical-store----canonical-store) |
