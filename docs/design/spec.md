...
| 5 | `local-inference` | planned | Ollama/vLLM conformance, structured outputs, model-fit, and local-only endpoint gates pass | [Local inference](../impl/current/local-inference.md); remaining scheduler in [open work](../impl/plan.md#local-inference----local-inference) |
