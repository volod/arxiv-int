...
| [0071 Russian tokenization and BM25 calibration](0071-lexical-calibrate-russian-tokenization-and-bm25.md) | Compare declared Russian lexical tokenizer and query profiles on a held-out set with paired quality and cost evidence | Accepted; bounded query normalization adopted without reindex |
