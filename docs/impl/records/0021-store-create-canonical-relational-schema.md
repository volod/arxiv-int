...
[0024](0024-store-implement-dbt-transformation-foundation.md); the run ledger is recorded in
[0041](0041-pipeline-implement-run-ledger-and-atomic-artifacts.md); projections are recorded in
