...
comparison verdicts, atomic checksum-verified run bundles, and Git-bound identity export.
...
identities. Artifact hashing is chunked; claimed durability, memory bounds, and the identity
