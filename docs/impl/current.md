...
| [Pipeline control](current/pipeline-control.md) | Typed stage/source/artifact interfaces, generic run ledger, and fixture DAG CLI/Make; forecast and publication remain planned |
