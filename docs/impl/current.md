...
| [Pipeline control](current/pipeline-control.md) | Typed stage/source/artifact interfaces, generic run ledger, fixture DAG CLI/Make, serialized progress logs, bounded resource telemetry, and a read-only pre-run forecast; publication remains planned |
