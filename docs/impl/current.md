...
| [Corpus foundation](current/corpus-foundation.md) | Streaming inventory, tiered extraction, NFC/search views, reversible duplicate overlays, structure-aware chunks, content identities, archive policy, quarantine metadata, restart checkpoints and validated Parquet partitions |
